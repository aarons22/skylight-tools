...
var categoriesListCategoriesCmd = &cobra.Command{
	Use:   "listCategories",
	Short: "List family member profile categories",
	Args:  cobra.NoArgs,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		resp, err := c.Do("GET", "/frames/{frameId}/categories",
...
func init() {
	categoriesCmd.AddCommand(categoriesListCategoriesCmd)
}
